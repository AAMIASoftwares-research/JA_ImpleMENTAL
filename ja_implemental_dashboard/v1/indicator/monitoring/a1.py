...
class _widgets(object):
    def __init__(self, language_code: str, disease_code: str):
        self._language_code = language_code
...
if __name__ == "__main__":
    widgets_instance = _widgets(language_code="en", disease_code="_depression_")
    app = widgets_instance.get_panel(language_code="it")
    app.show()


    # create widget for age
    # a column with two rows:
    #  first row 3 pn.widgets.Switch for age codes a, l, u
    # second row pn.widgets.IntRangeSlider for age value
    ...
    # layout
    #age_widget_instance = age_widget()
    #app = age_widget_instance.panel
    #app.show()
